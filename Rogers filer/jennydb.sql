...
CREATE TABLE `authors` (
  ...
  `authorName` varchar(50) COLLATE utf8_swedish_ci NOT NULL,
...
INSERT INTO `authors` (`authorId`, `authorName`, `publisherId`) VALUES
(3, 'J.K. Rowlings', 1),
(4, 'J.R.R. Tolkien', 2),
(5, 'Astrid Lindgren', 3);
...
CREATE TABLE `books` (
  ...
  `bookTitle` varchar(50) COLLATE utf8_swedish_ci NOT NULL,
...
(1, 'Harry Potter. The Philosopher\'s Stone', 3),
(2, 'The Fellowship of the Ring', 4),
(3, 'Mio min Mio', 5),
(4, 'Harry Potter. The Chamber of Secrets', 3),
(5, 'The Two Towers', 4),
(6, 'Ronja Rövardotter', 5),
(7, 'Harry Potter. The Prisoner of Azkaban', 3),
(8, 'The Return of the King', 4),
(9, 'Bröderna Lejonhjärta', 5),
(16, 'Nya hyss av Emil i Lönneberga', 5),
(20, 'Karlsson på taket', 5);
...
INSERT INTO `users` (`userId`, `userName`, `userAuth`) VALUES
(1, 'test', 'testtest'),
(2, 'test2', 'test2test2');
...
--
ALTER TABLE `authors`
  ADD CONSTRAINT `fk_publisherId` FOREIGN KEY (`publisherId`) REFERENCES `publishers` (`publisherId`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
